...
const displayTeamName = team => `${FLAGS[team] || ""} ${DE[team] || team || "Team"}`.trim();
...
function StatsPanel({ subTab, history, chartPeople, cardStats }) {
...
export default function App() {
  ...
  if (tab === "liga") {
    ...
    screen = <StatsPanel subTab={activeSubTab} history={pointsHistory} chartPeople={chartPeople} cardStats={cardStats} />;
  } else if (tab === "mein") {
